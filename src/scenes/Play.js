class Play extends Phaser.Scene {
    ...
    shootAsteroid(pointer) {
        this.sound.play('laser', { volume: 2 }) // play once
        ...
        this.asteroids.children.iterate((asteroid) => {
            if (asteroid && Phaser.Geom.Intersects.RectangleToRectangle(
                ...
                if (this.randomNum == 0) {
                    this.sound.play('explosion0', { volume: 0.05 })
                }
                if (this.randomNum == 1) {
                    this.sound.play('explosion1', { volume: 0.05 })
                }
                if (this.randomNum == 2) {
                    this.sound.play('explosion2', { volume: 0.05 })
                }
                if (this.randomNum == 3) {
                    this.sound.play('explosion3', { volume: 0.05 })
                }
            }
        })
    }
